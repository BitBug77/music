...
export default function Sidebar() {
  ...
  const handleSearchClick = () => {
    ...
    if (window.innerWidth < 768) {
      setIsOpen(false) // Close sidebar on mobile when clicking search
    }
  }
  ...
  return (
    <>
      ...
      >
        <div className="mb-8 mt-14">
          <div className="space-y-4">
            ...
            <MenuItem icon={<Search size={20} />} label="Search" href="" onClick={handleSearchClick} />
        ...
        <div className="border-t border-[#74686e]/30 pt-4 mt-auto">
          ...
          <a href="#" className="text-sm block mt-2 text-white/80 hover:text-white transition duration-200">
            Privacy Policy
          </a>
        </div>
      </div>
      ...
      <div className="fixed top-0 left-0 w-6 h-full z-10" onMouseEnter={() => setIsOpen(true)}></div>
    </>
  )
}
